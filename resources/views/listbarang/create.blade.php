                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="kodebarang" id="kodebarang" value="" placeholder="Enter Kode Barang">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="namabarang" class="form-label">Nama Barang</label>
                            <input class="form-control" type="text" name="namabarang" id="namabarang" value="" placeholder="Enter Nama Barang">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="hargabarang" class="formlabel">Harga Barang</label>
                            <input class="form-control" type="text" name="hargabarang" id="hargabarang" value="" placeholder="Enter Harga Barang">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="deskripsibarang" class="form-label">Deskripsi Barang</label>
                            <input class="form-control" type="text" name="deskripsibarang" id="deskripsibarang" value="" placeholder="Enter Deskripsi Barang">
                        </div>
